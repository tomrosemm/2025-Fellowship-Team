...
# Leftover to allow switching between simulated and real ZKP generation and quickly ensure 
# A refactored naming convention was able to be applied without being absolute certain in its uniform conformity
